			...
			<table summary="게시판 글쓰기">
				...
				<tbody>
					...
					<tr>
						...
						<td><textarea name="cont" cols="50" rows="8"></textarea></td>
					...
					<tr>
						...
						<td><input type="password" name="pwd" id="write" size="12" /></td>
					...
					<tr>
						...
						<input type="button" value="목록" onclick="viewList('<%=nowPage%>')" />
						</td>
